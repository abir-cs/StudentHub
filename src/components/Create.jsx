...
const Create = () => {
    ...
    const checkFullName=(name)=>{
        ...
        if (nameRegex.test(name))
            ...
            return("not correct full name format !");
    ...
    const checkAVG=(avg)=>{
        ...
        if (numRegex.test(avg))
        {
            if(avg>=0 && avg<=20)
                ...
                return("average is bound by [0-20] !");
        }
        else
            return("not correct number format !");
    ...
    return ( <div className="create">
        ...
        <form onSubmit={addcourse}>
            ...
            <input type="text" required onChange={e=>setCourseName(e.target.value)} />
            <label>teacher full name</label>
            <input type="text" required onChange={e=>setTeacher(e.target.value)}/>
            ...
            <input type="number" min="0" required onChange={e=>setSessions(e.target.value)}/>
            <button className="onlyme">Add</button>
        </form>
